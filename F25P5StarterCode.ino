...
uint8_t bd_addr[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};  // Kit NN BLE MAC address
...
void drawTemp() {
  ...
  tft.drawString("This space", 3*TFT_HEIGHT/4, 90);
  tft.drawString("for rent", 3*TFT_HEIGHT/4, 120);
}
